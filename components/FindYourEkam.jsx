        ...
        <div className="fy__grid">
          ...
          <div className="fy-form">
            ...
            <div className="fy-toggles">
              <button
                ...
                <span className="fy-toggle__body">
                  ...
                  <span className="fy-toggle__hint" style={{ fontFamily: "Raleway", fontWeight: "400" }}>₹120/night — funds saplings near the cabin you slept in.</span>
                </span>
              </button>
              <button
                ...
                <span className="fy-toggle__body">
                  ...
                  <span className="fy-toggle__hint" style={{ fontSize: "12px", fontFamily: "Raleway" }}>1% — the panchayat decides how it's spent.</span>
                </span>
              </button>
            </div>
            ...
            <div className="fy-sum">
              <div className="fy-sum__line" style={{ fontWeight: "400" }}>
              ...
              {offsetFee > 0 &&
              <div className="fy-sum__line sm" style={{ fontWeight: "400" }}>
              ...
              <div className="fy-sum__line total" style={{ fontWeight: "600", fontSize: "24px", fontFamily: "Inter" }}>
                <span style={{ fontSize: "24px", fontFamily: "Inter", fontWeight: "600" }}>Your stay</span>
                <span>₹{total.toLocaleString('en-IN')}</span>
              </div>
            </div>

            <button className="fy-cta" onClick={() => setConfirmed(true)} style={{ borderRadius: "0px" }}>
              <span className="fy-cta__dot"></span>
              Reserve · ₹{total.toLocaleString('en-IN')}
            </button>
            <p className="fy-hint" style={{ fontFamily: "Raleway", fontWeight: "500" }}>No payment yet. We hold the cabin for 24 hours.</p>
          </div>
        </div>
      </div>
    </div>);
