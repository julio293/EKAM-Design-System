...
import cabinPhoto from '../../figma-export/assets/cabinPhoto.js';

export const Variants = () => (
  <div style={{ display: 'flex', flexDirection: 'column', gap: 24, width: '100%', maxWidth: 340 }}>
    <Card image={cabinPhoto} eyebrow="EKAM · CABIN" title="Binsar." subtitle="Kumaon · 2,400 m" scriptLabel="कुटीर" />
